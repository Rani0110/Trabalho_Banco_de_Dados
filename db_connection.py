...
# Parâmetros de conexão - priorizar variáveis de ambiente
# ATENÇÃO: Para produção, configure estas variáveis de ambiente e evite hardcoding.
SERVER = os.getenv('DB_SERVER', 'srl-bd.database.windows.net')
DATABASE = os.getenv('DB_DATABASE', 'TrabalhoDeBD-SRL')
USERNAME = os.getenv('DB_USERNAME', 'Vitoria')
PASSWORD = os.getenv('DB_PASSWORD', 'SenhaDificil123')
